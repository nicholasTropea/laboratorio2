...
# qualsiasi (>= 1) di argomenti posizionali
def multi_somma(a,*altri): # altri è una n-upla di parametri (IMMUTABLE)
  for b in altri:
    a += b
  return a
...
# accetta un numero qualsiasi di argomenti keywords e li mette in kwargs (dizionario con chiavi le keyword)
