...
# di confronto in funzione di quelli forniti nelle classi
# per approfondire:
...
@functools.total_ordering # Scritto __lt__ calcola automaticamente gli altri comparatori
class Articolo:
    ...
    def __init__(self, nome, prezzo, commenti=None): # commenti è un parametro opzionale
        ...
        Articolo.articoli_totali += 1  # modifica dell'attributo di classe (statico)
